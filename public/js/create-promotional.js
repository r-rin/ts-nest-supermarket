const formSelector = document.querySelector('#createPromForm');
...
function sendForm() {
  ...
  formDataObj.UPC_prom = formDataObj.UPC_prom
    .toUpperCase()
    .padEnd(12, '0');
  document.querySelector('#UPC_prom').value = formDataObj.UPC_prom;

  fetch('/api/supplies/create-promotional', {
    method: 'POST',
    headers: {
