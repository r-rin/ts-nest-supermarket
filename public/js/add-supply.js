const formSelector = document.querySelector('#addSupplyForm');
...
function sendForm() {
  ...
  formDataObj.UPC = formDataObj.UPC
    .toUpperCase()
    .padEnd(12, '0');
  document.querySelector('#UPC').value = formDataObj.UPC;

  fetch('/api/supplies/add', {
    method: 'POST',
    headers: {
