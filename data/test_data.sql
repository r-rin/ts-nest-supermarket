...
VALUES ('EMP002', 'Johnson', 'Emily', 'Pauline', 'Manager', 3500.00, '2022-11-20', '1985-09-12', '+1987654321',
        'Los Angeles', 'Broadway', '90001');

INSERT INTO employee (employee_id, employee_surname, employee_name, employee_patronymic, employee_role,
                      employee_salary, employee_start_date, employee_birth_date, employee_phone_number,
                      employee_city, employee_street, employee_zip_code)
VALUES ('EMP005', 'Brown', 'Michael', 'Christopher', 'Manager', 3200.00, '2023-02-05', '1988-03-25', '+1321567890',
...
VALUES ('EMP007', 'Garcia', 'Sophia', 'Manager', 3400.00, '2023-03-15', '1991-07-18', '+1654321890',
        'Miami', 'Palm St.', '33101');

INSERT INTO employee (employee_id, employee_surname, employee_name, employee_role, employee_salary,
                      employee_start_date, employee_birth_date, employee_phone_number, employee_city,
                      employee_street, employee_zip_code)
VALUES ('EMP009', 'Martinez', 'Daniel', 'Manager', 3300.00, '2023-04-10', '1993-11-30', '+1789056432',
        'Atlanta', 'Maple St.', '30301');

INSERT INTO employee (employee_id, employee_surname, employee_name, employee_role, employee_salary,
                      employee_start_date, employee_birth_date, employee_phone_number, employee_city,
                      employee_street, employee_zip_code)
VALUES ('EMP010', 'Lee', 'Jennifer', 'Manager', 3100.00, '2023-05-20', '1987-08-05', '+1908765432',
...
INSERT INTO employee (employee_id, employee_surname, employee_name, employee_patronymic, employee_role,
                      employee_salary, employee_start_date, employee_birth_date, employee_phone_number,
                      employee_city, employee_street, employee_zip_code)
VALUES ('EMP001', 'Smith', 'John', 'Andrew', 'Cashier', 2500.00, '2023-01-15', '1990-05-20', '+1234567890',
        'New York', 'Main St.', '10001');

INSERT INTO employee (employee_id, employee_surname, employee_name, employee_patronymic, employee_role,
                      employee_salary, employee_start_date, employee_birth_date, employee_phone_number,
                      employee_city, employee_street, employee_zip_code)
VALUES ('EMP003', 'Williams', 'David', 'Edward', 'Cashier', 2300.00, '2023-03-10', '1995-02-28', '+1324354657',
        'Chicago', 'Oak St.', '60601');

INSERT INTO employee (employee_id, employee_surname, employee_name, employee_role, employee_salary,
                      employee_start_date, employee_birth_date, employee_phone_number, employee_city,
                      employee_street, employee_zip_code)
VALUES ('EMP004', 'Jones', 'Jessica', 'Cashier', 2400.00, '2023-01-25', '1992-09-15', '+1432576890',
        'San Francisco', 'Pine St.', '94101');

INSERT INTO employee (employee_id, employee_surname, employee_name, employee_role, employee_salary,
                      employee_start_date, employee_birth_date, employee_phone_number, employee_city,
                      employee_street, employee_zip_code)
VALUES ('EMP006', 'Davis', 'Robert', 'Cashier', 2600.00, '2023-04-05', '1994-06-10', '+1567890234',
        'Dallas', 'Cedar St.', '75201');

INSERT INTO employee (employee_id, employee_surname, employee_name, employee_role, employee_salary,
                      employee_start_date, employee_birth_date, employee_phone_number, employee_city,
                      employee_street, employee_zip_code)
VALUES ('EMP008', 'Rodriguez', 'Amanda', 'Cashier', 2700.00, '2023-02-28', '1993-12-20', '+1678904321',
